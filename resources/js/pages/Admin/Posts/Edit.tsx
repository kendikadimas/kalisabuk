                        ...
                        <div className="grid w-full max-w-sm items-center gap-1.5">
                            ...
                            {post.image_path && (
                                <div className="mt-2 text-sm text-muted-foreground">
                                    Gambar saat ini: <a href={post.image_path.startsWith('http') ? post.image_path : `/storage/${post.image_path}`} target="_blank" className="text-primary hover:underline" rel="noreferrer">Lihat</a>
                                </div>
                            )}
                        </div>
