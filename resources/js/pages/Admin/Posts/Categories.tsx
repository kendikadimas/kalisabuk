...
export default function PostCategories({ categories }: { categories: any[] }) {
    ...
    const submitEdit = (e: React.FormEvent) => {
        ...
        put(route('post-categories.update', editingItem.id), {
            onSuccess: () => {
                setEditingItem(null);
                reset();
            }
    ...
    const handleDelete = (id: number) => {
        router.delete(route('post-categories.destroy', id), {
            preserveScroll: true,
        });
    };
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm">Kelola kategori untuk berita dan artikel desa.</p>
                        </div>
                    </div>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                    Kategori "{category.name}" akan dihapus. Pastikan tidak ada berita yang menggunakan kategori ini.
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
                ...
                <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>Buat kategori baru untuk pengelompokan berita desa.</DialogDescription>
                        </DialogHeader>
                        <form onSubmit={submitCreate} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Contoh: Kegiatan Desa, Pengumuman"
                                    required
                                />
