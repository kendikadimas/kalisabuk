            ...
            <div className="p-6 md:p-8 space-y-8 bg-slate-50/50 min-h-full">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 text-sm">Perbarui informasi atau gambar slide.</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <Label htmlFor="image_path" className="text-slate-700 font-medium">Gambar Slide</Label>
                                <div className="border-2 border-dashed border-slate-200 rounded-xl p-8 hover:bg-slate-50 transition-colors text-center cursor-pointer group relative aspect-video flex flex-col items-center justify-center bg-slate-50/50 overflow-hidden">
                                    ...
                                    {data.image_path ? (
                                        ...
                                        <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center z-0">
                                            ...
                                            />
                                            <div className="relative z-10 bg-white/80 backdrop-blur-sm p-4 rounded-xl shadow-sm border border-white/50 flex flex-col items-center gap-2">
                                                <ImageIcon className="w-6 h-6 text-emerald-600" />
                                                <p className="text-sm font-semibold text-slate-700">Klik untuk ganti gambar</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
