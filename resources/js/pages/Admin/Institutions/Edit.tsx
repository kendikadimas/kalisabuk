...
import { ArrowLeft, Save, Building2, User, FileText, Image as ImageIcon, ExternalLink } from 'lucide-react';

export default function InstitutionEdit({ institution }: { institution: any }) {
        ...
        <AppSidebarLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6 md:p-8 space-y-8 bg-slate-50/50 min-h-full">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">Edit Lembaga</h1>
                        <p className="text-slate-500 text-sm">Perbarui data lembaga kemasyarakatan desa.</p>
                    </div>
                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 hover:bg-slate-50 transition-colors text-center cursor-pointer group relative">
                                        ...
                                        <div className="flex flex-col items-center gap-2">
                                            ...
                                            <p className="text-sm text-slate-500 font-medium">{institution.logo ? 'Ganti Logo' : 'Upload Logo'}</p>
                                    ...
                                    {institution.logo && (
                                        <div className="flex items-center justify-between mt-2 p-3 bg-slate-50 rounded-lg border border-slate-100">
                                            <div className="text-xs text-slate-500 flex items-center">
                                                ...
                                                Logo saat ini tersedia
                                            </div>
                                            <a
                                                href={`/storage/${institution.logo}`}
                                                target="_blank"
