...
export default function DemographicCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Data Demografi" />

            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="max-w-3xl">
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold tracking-tight">Tambah Data Demografi</h2>
                        <p className="text-muted-foreground">Tambahkan data statistik kependudukan.</p>
                    </div>
