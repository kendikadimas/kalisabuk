...
export default function BudgetCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Data APBDes" />

            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="max-w-3xl">
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold tracking-tight">Tambah Data APBDes</h2>
                        <p className="text-muted-foreground">Tambahkan data anggaran pendapatan atau belanja desa.</p>
                    </div>
