...
export default function EditServiceType({ serviceType }: { serviceType: any }) {
    ...
    const { data, setData, put, processing, errors } = useForm<{
        ...
        processing_time: serviceType.processing_time || '',
        fee: serviceType.fee || ''
    });
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('services.update', serviceType.id));
    };

    return (
        <AppSidebarLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Jenis Layanan" />
            ...
            <div className="p-6 md:p-8 space-y-8 bg-slate-50/50 min-h-full">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">Edit Jenis Layanan</h1>
                        <p className="text-slate-500 text-sm">Ubah informasi jenis layanan "{serviceType.name}".</p>
                    </div>
                </div>
